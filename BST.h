...
private:
    ...
    bool isMirror(BinNodePointer p1, BinNodePointer p2) const;
    unsigned numLeaves(BinNodePointer r) const;
...
/*
template <typename DataType>
inline unsigned BST<DataType>::numLeaves() const
{
   return numLeaves(myRoot);
}
*/
...
template <typename DataType>
unsigned BST <DataType>::numLeaves(BinNodePointer r) const
{
    if (r == NULL) {
        return 1;
    }
